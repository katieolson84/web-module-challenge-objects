...
console.log(createMenuItems('sandwich',8,'Lunch'));
console.log(createMenuItems('hotdog',4,'Lunch'));
...
console.log(addReview(reviews,"Katie", 1, "There was a hair in my food, so I was not happy."));
